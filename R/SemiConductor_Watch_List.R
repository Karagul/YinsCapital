#' @title Watchlist for Semiconductor for Designated Stock Ticker
#' @description Watchlist for Semiconductor for Designated Stock Ticker
#' @param
#' @return
#' @examples SemiConductor_Watch_List()
#' @export SemiConductor_Watch_List
#'
#' # Define function
SemiConductor_Watch_List <- function(
  buy.height = -1.96,
  past.days = 3
) {
  # Download Stock Pool:
