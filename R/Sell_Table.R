#' @title Sell Signal Table for Designated Stock Ticker
#' @description Sell Signal Table for Designated Stock Ticker
#' @param
#' @return
#' @examples Sell_Table()
#' @export Sell_Table
#'
#' # Define function
Sell_Table <- function(x,r_day_plot,end_day_plot,c,height,past.n.days,test.new.price = 0){
  if (test.new.price == 0) {
    x = x
  } else {
