#' @title Watchlist for QQQ for Designated Stock Ticker
#' @description Watchlist for QQQ for Designated Stock Ticker
#' @param
#' @return
#' @examples QQQ_Watch_List()
#' @export QQQ_Watch_List
#'
#' # Define function
QQQ_Watch_List <- function(
  buy.height = -1.96,
  past.days = 3
) {
  # Download Stock Pool:
