#' @title Watchlist for XLP for Designated Stock Ticker
#' @description Watchlist for XLP for Designated Stock Ticker
#' @param
#' @return
#' @examples XLP_Watch_List()
#' @export XLP_Watch_List
#'
#' # Define function
XLP_Watch_List <- function(
  buy.height = -1.96,
  past.days = 3
) {
  # Download Stock Pool:
