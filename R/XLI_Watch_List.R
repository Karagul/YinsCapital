#' @title Watchlist for XLI for Designated Stock Ticker
#' @description Watchlist for XLI for Designated Stock Ticker
#' @param
#' @return
#' @examples XLI_Watch_List()
#' @export XLI_Watch_List
#'
#' # Define function
XLI_Watch_List <- function(
  buy.height = -1.96,
  past.days = 3
) {
  # Download Stock Pool:
